...
//    int HP = 30;// 血量
    ...
    public void paintSelf(Graphics g) {
        ...
        if (HP <= 0) {
            ...
            // 1.我方飞机和敌方小飞机碰撞
            if (GameUtils.enemySmallPlaneList != null && GameUtils.enemySmallPlaneList.size() > 0) {
            ...
            // 2.我方飞机和敌方大飞机碰撞
            if (GameUtils.enemyBigPlaneList != null && GameUtils.enemyBigPlaneList.size() > 0) {
            ...
            // 3.我方飞机和敌方大飞机子弹碰撞
            if (GameUtils.enemyBigPlaneBulletList != null && GameUtils.enemyBigPlaneBulletList.size() > 0) {
            ...
            // 5.我方飞机与敌方小boss子弹碰撞
            if (GameUtils.littleBossBulletList != null && GameUtils.littleBossBulletList.size() > 0) {
            ...
            // 6.我方飞机与补给gift1碰撞
            if (GameUtils.gift1List != null && GameUtils.gift1List.size() > 0) {
            ...
            // 7.我方飞机与补给gift2碰撞
            if (GameUtils.gift2List != null && GameUtils.gift2List.size() > 0) {
            ...
            // 8.我方飞机与补给gift3碰撞
            if (GameUtils.gift3List != null && GameUtils.gift3List.size() > 0) {
            ...
            // 9.我方飞机与补给飞机碰撞
            if (GameUtils.giftSupplyPlaneArrayList != null && GameUtils.giftSupplyPlaneArrayList.size() > 0) {
            ...
            if (GameUtils.bigBossBullet1List != null && GameUtils.bigBossBullet1List.size() > 0) {
            ...
            // 12.我方飞机与敌方大boss子弹碰撞
            if (GameUtils.bigBossBullet2List != null && GameUtils.bigBossBullet2List.size() > 0) {
