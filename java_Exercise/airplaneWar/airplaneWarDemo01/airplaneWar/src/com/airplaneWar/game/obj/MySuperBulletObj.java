...
public class MySuperBulletObj extends GameObj {
    ...
    static {
        mySuperBullet[0] = Toolkit.getDefaultToolkit().getImage(GameUtils.absolutePathPrefix + "images/bullet/ttt04.png");
        mySuperBullet[1] = Toolkit.getDefaultToolkit().getImage(GameUtils.absolutePathPrefix + "images/bullet/ttt05.png");
        mySuperBullet[2] = Toolkit.getDefaultToolkit().getImage(GameUtils.absolutePathPrefix + "images/bullet/ttt06.png");
        mySuperBullet[3] = Toolkit.getDefaultToolkit().getImage(GameUtils.absolutePathPrefix + "images/bullet/ttt07.png");
        mySuperBullet[4] = Toolkit.getDefaultToolkit().getImage(GameUtils.absolutePathPrefix + "images/bullet/ttt08.png");
    }
