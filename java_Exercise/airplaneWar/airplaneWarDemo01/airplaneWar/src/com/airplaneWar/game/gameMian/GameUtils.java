...
public class GameUtils {
    ...
    // 所有图片的绝对路径前缀
    public static String absolutePathPrefix = "D:/Java/javacode/java_Exercise/airplaneWar/airplaneWarDemo01/airplaneWar/";

    // 获取背景图片
    public static Image backgroundImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bg/bg.jpg");
    public static Image backgroundImg2 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bg/bg0.jpg");
    public static Image backgroundImg3 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bg/bg1.jpg");
    public static Image backgroundImg4 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bg/bg2.jpg");

    // 获取我方飞机图片
    public static Image myPlaneImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/hero_b_1.png");
    public static Image myPlaneImg2 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/hero_b_02.png");
    public static Image myPlaneImg3 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/hero_b_03.png");
    public static Image myPlaneImg4 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/hero_b_04.png");
    public static Image myPlaneImg5 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/hero2.png");

    // 获取我方子弹图片
    public static Image myBulletImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/bullet1.png");
    public static Image myBulletImg2 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/bullet3l.png");
    public static Image myBulletImg3 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/bullet3r.png");
    public static Image myBulletImg4 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/bullet4l.png");
    public static Image myBulletImg5 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/bullet4r.png");

    // 获取敌方小飞机图片
    public static Image enemySmallPlaneImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/enemy/enemy.png");

    // 获取敌方大飞机图片
    public static Image enemyBigPlaneImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/enemy/enemy22.png");

    // 获取敌方大飞机子弹图片
    public static Image enemyBigPlaneBulletImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/enemy_bullet2.png");

    // 获取小boss的图片
    public static Image littleBossImg = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/enemy/boss.png");

    // 获取小boss子弹图片
    public static Image littleBossBulletImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/10.png");

    // 获取爆炸图片
    public static Image boomImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/boom/boom01.png");

    // 获取补给的图片
    public static Image giftImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/article1.png");
    public static Image giftImg2 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/hero_blood.png");
    public static Image giftImg3 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/supply.png");

    // 获取补给飞机图片
    public static Image giftSupplyPlaneImg1 = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/hero/bullet_supply.png");

    // 获取大boss图片
    public static Image bigBossImg = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/enemy/super_boss.png");

    // 获取大boss子弹图片
    public static Image bigBossBullet1Img = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/boss_bullet2.png");
    public static Image bigBossBullet2Img = Toolkit.getDefaultToolkit().getImage(absolutePathPrefix + "images/bullet/boss_bullet.png");
