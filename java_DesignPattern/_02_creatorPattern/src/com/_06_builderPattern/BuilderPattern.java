package com._06_builderPattern;
...
//  简单来说，建造者模式将一个复杂对象拆分成多个零件，则创建该对象的步骤就变为【①创建各零件】【②组装零件】
//  注意：
...
//      具体建造者类(ConcreteBuilder):实现Builder 接口,完成复杂产品的各个部件的具体创建方法。在构造过程完成后,提供产品的实例。
//      指挥者类(Director):调用具体建造者来创建复杂对象的各个部分,在指导者中不涉及具体产品的信息,只负责保证对象各部分完整创建或按某种顺序创建。
//      产品类(Product):要创建的复杂对象。
//  注意：
//      构建者Builder中，包含该构建者要构建的产品Product对象。
//      指挥者Director中，包含该指挥者要组装的构建者Builder对象。
//      这样提高了代码的复用性。
//
//
// 3.优缺点G
